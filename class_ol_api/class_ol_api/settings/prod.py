"""
Django settings for class_ol_api project.
...
ROOT_URLCONF = 'class_ol_api.urls'
...
WSGI_APPLICATION = 'class_ol_api.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(os.path.dirname(BASE_DIR), 'logs/class_ol.log'),
            # 通过什么类实现
...
REST_FRAMEWORK = {
    # 异常处理
    'EXCEPTION_HANDLER': 'class_ol_api.utils.exceptions.custom_exception_handler',
    # 配置JWT
...
# django文件存储
DEFAULT_FILE_STORAGE = 'class_ol_api.utils.fastdfs.fdfs_storage.FastDFSStorage'
