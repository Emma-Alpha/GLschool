<template>
  <div class="mod_row_box" id="new_vs_hot_movie"
    ...
    <div class="mod_bd cf _quickopen _quickopen_duration" v-for="college in college_list">
    ...
    " data-rowcount="6" data-rowlen="2">
            ...
            <div class="list_item " v-for="course in course_dict.results" v-if="course.is_show">
              ...
              <a :href="`/video_detail/`+course.id"
                ...
                <div class="figure_score">{{course.level_text}}</div>
              ...
              <div class="figure_detail figure_detail_two_row  ">
                ...
                <div class="figure_desc" :title="course.brief">{{course.brief}}</div>
      ...
      <div class="mod_column_side">
        <div class="mod_hd mod_column_hd">
          <h2 class="mod_title">{{college.name}}排行榜</h2>
        ...
        <div class="mod_rank_list mod_rank_list_1column  ">
          ...
          <a :href="`/video_detail/`+rank.id" v-for="rank,key in rank_list" class="rank_item rank_item_1 cf" title="叶问4"
            ...
            <span class="rank_desc">{{rank.teacher.name}}</span>


            <span class="rank_update">{{rank.students}}人</span>
...
<script>
    export default {
        ...
        methods: {
            ...
            get_course() {
                this.$axios.get(`${this.$settings.Host}/course/course_all/`, {}).then(response => {
                    this.course_dict = response.data;
            ...
            ranking_list(){
                this.$axios.get(`${this.$settings.Host}/course/ranking_list/`).then(response => {
                    this.rank_list = response.data.results
                }).catch(error => {
                    this.$alert("网络错误！", "广东理工学院")
                })
            }
