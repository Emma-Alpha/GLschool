...
<!--		<img src="../../static/image/Loginbg.3377d0c.jpg" alt="">-->
		<div class="login" style="background-color: #24292e">
			<div class="login-title">
				<img src="../../static/image/Gdlgxylogo.png" style="margin-top: 100px">
				<p>崇尚科学，打造品牌，注重内涵，服务创新</p>
			</div>
			<div class="login_box">
				<div class="title">
  ...
  methods:{
    ...
    LoginHandler(){
        ...
        this.$axios.post(`${this.$settings.Host}/user/login/`,{
            ...
            // 保存了token以后，进行页面跳转
            let self = this;
            this.$alert("登录成功！欢迎回来", "广东理工学院",{
                callback(){
                    // self.$router进行页面跳转 self.$route 获取url
                    self.$router.go(-1)
                }
            })

        }).catch(error=>{
            this.$alert("账号或密码错误", "广东理工学院")
        })
    }
  },
